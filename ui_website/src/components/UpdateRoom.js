...
const UpdateRoom = () => {
    ...
    const validateInput = (inputName, value) => {
        ...
        if (inputName === "room_type" && value.trim() === "") {
    ...
    return (
        <div className="container mt-5 mb-3">
            ...
            <div className="justify-content-center  mt-3 ">
                    ...
                    <div className="" style={{ width: "60%" }}>
                        ...
                        <div className="form-group mb-2 d-flex">
                            ...
                            <input
                                type="text" maxLength={30} minLength={1} required={true}
                                placeholder="Enter room name "
                                className={`form-control w-75 ${validationErrors.room_type && 'is-invalid'}`}
                                value={room.type}
                                onChange={(e) => handleInputChange("room_type", e.target.value)}
                                onBlur={(e) => handleBlur("room_type", e.target.value)}
                            />
                            {validationErrors.room_type && (
                                <div className="invalid-feedback">{validationErrors.room_type}</div>
                            )}
                        ...
                        <div className="form-group mb-2  d-flex">
                            <label htmlFor="images" className="drop-container " id="dropcontainer" style={{ width: "70%" }}>
                                <span className="drop-title">Drop files here</span>
                                or
                                <input type="file" multiple id="images" className="mb-3" accept="image/*" onChange={handleImageChange} required />
                            </label>
                            <br />

                        </div><br />
                        <div className="d-flex flex-wrap">
                            {room_img ? room_img.map((file, i) => (
                ...
                <div className='d-flex col-ms-6  mt-3 mb-3  justify-content-center'>
                    <div className='col-3 '>
